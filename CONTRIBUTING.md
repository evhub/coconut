...
Then, you should be able to use the Coconut command-line for trying out simple things, and to run a pared-down version of the test suite locally, just `make test-basic`.
