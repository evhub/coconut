...
@_t.overload
def _coconut_comma_op(*args: _t.Any) -> _t.Tuple[_t.Any, ...]: ...
...
@_t.overload
def flip(func: _t.Callable[[_T, _U, _V], _W]) -> _t.Callable[[_U, _T, _V], _W]: ...
@_t.overload
def flip(func: _t.Callable[..., _T]) -> _t.Callable[..., _T]: ...
