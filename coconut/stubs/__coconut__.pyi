...
@overload
def _coconut_forward_compose(g: Callable[..., _T], f: Callable[[_T], _U]) -> Callable[..., _U]: ...
@overload
...
@overload
def _coconut_back_compose(f: Callable[[_T], _U], g: Callable[..., _T]) -> Callable[..., _U]: ...
@overload
def _coconut_back_compose(*funcs: Callable) -> Callable: ...
_coconut_back_star_compose = _coconut_back_compose


def _coconut_pipe(x: _T, f: Callable[[_T], _U]) -> _U: ...
def _coconut_back_pipe(f: Callable[[_T], _U], x: _T) -> _U: ...
