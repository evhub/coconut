...
from coconut.const import code_exts, comp_ext, \
                    main_sig, debug_sig, \
                    default_prompt, default_moreprompt, \
                    watch_interval, color_codes, end_color_code, \
                    version_long, version_banner, version_tag, \
                    tutorial_url, documentation_url, \
                    icoconut_dir, icoconut_kernel_dirs
from .utils import openfile, writefile, readfile, \
                            showpath, fixpath, \
